...
sbatch --export=SEED=$SEED,DATA_TYPE=image,N_SAMPLES=20,STEPS=5,SKIP=1 transformer.slurm;
sbatch --export=SEED=$SEED,DATA_TYPE=image,N_SAMPLES=20,STEPS=5,SKIP=2 transformer.slurm;
...
sbatch --export=SEED=$SEED,DATA_TYPE=image,N_SAMPLES=50,STEPS=5,SKIP=1 transformer.slurm;
sbatch --export=SEED=$SEED,DATA_TYPE=image,N_SAMPLES=50,STEPS=5,SKIP=2 transformer.slurm;
...
sbatch --export=SEED=$SEED,DATA_TYPE=image,N_SAMPLES=100,STEPS=5,SKIP=1 transformer.slurm;
sbatch --export=SEED=$SEED,DATA_TYPE=image,N_SAMPLES=100,STEPS=5,SKIP=2 transformer.slurm;
...
sbatch --export=SEED=$SEED,DATA_TYPE=bits,N_SAMPLES=20,STEPS=5,SKIP=1 transformer.slurm;
sbatch --export=SEED=$SEED,DATA_TYPE=bits,N_SAMPLES=20,STEPS=5,SKIP=2 transformer.slurm;
...
sbatch --export=SEED=$SEED,DATA_TYPE=bits,N_SAMPLES=50,STEPS=5,SKIP=1 transformer.slurm;
sbatch --export=SEED=$SEED,DATA_TYPE=bits,N_SAMPLES=50,STEPS=5,SKIP=2 transformer.slurm;
...
sbatch --export=SEED=$SEED,DATA_TYPE=bits,N_SAMPLES=100,STEPS=5,SKIP=1 transformer.slurm;
sbatch --export=SEED=$SEED,DATA_TYPE=bits,N_SAMPLES=100,STEPS=5,SKIP=2 transformer.slurm;